...
#arch-chroot /mnt /bin/bash -c "echo -e 127.0.0.1	localhost.localdomain	localhost >> /etc/hosts"
#arch-chroot /mnt /bin/bash -c "echo -e ::1		localhost.localdomain	localhost >> /etc/hosts"
