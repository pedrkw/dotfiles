...
read $tmp
vim /etc/pacman.conf
pacstrap -K /mnt linux linux-headers linux-firmware base base-devel flameshot sof-firmware vivaldi vivaldi-ffmpeg-codecs bash-completion pipewire lib32-pipewire pipewire-alsa pipewire-pulse wireplumber maim aria2 bitwarden vulkan-radeon xf86-video-amdgpu lib32-vulkan-radeon lib32-mesa libva-mesa-driver lib32-libva-mesa-driver mesa-vdpau lib32-mesa-vdpau steam gamemode lib32-gamemode libva-vdpau-driver libvdpau-va-gl vulkan-tools obs-studio papirus-icon-theme materia-gtk-theme discord giflib lib32-giflib libpng lib32-libpng libldap lib32-libldap gnutls lib32-gnutls mpg123 lib32-mpg123 openal lib32-openal v4l-utils lib32-v4l-utils libpulse lib32-libpulse libgpg-error lib32-libgpg-error alsa-plugins alsa-firmware lib32-alsa-plugins alsa-lib lib32-alsa-lib libjpeg-turbo lib32-libjpeg-turbo sqlite lib32-sqlite libxcomposite lib32-libxcomposite libxinerama lib32-libgcrypt libgcrypt lib32-libxinerama ncurses lib32-ncurses ocl-icd lib32-ocl-icd libxslt lib32-libxslt libva lib32-libva gtk3 lib32-gtk3 gst-plugins-base-libs lib32-gst-plugins-base-libs lutris networkmanager vim grub xorg-server xorg-xinit lvm2 firefox gnu-free-fonts noto-fonts-emoji noto-fonts-cjk noto-fonts ttf-liberation ttf-croscore ttf-dejavu ttf-bitstream-vera ttf-droid ttf-croscore ttf-ibm-plex git xdg-user-dirs openssh ufw pacman-contrib efibootmgr reflector qbittorrent terminus-font zsh zsh-autosuggestions zsh-completions
#removed pkgs: gufw gparted
...
arch-chroot /mnt /bin/bash -c "pacman -Syu  plasma-meta dolphin vlc elisa materia-kde kvantum-theme-materia konsole sddm kvantum spectacle okular kate kdialog dolphin-plugins ffmpegthumbs gwenview kdegraphics-thumbnailers yakuake ark sweeper ksystemlog kmag kdeconnect libktorrent qt5-imageformats kimageformats kwalletmanager qtcurve-gtk2 qtcurve-utils xdg-desktop-portal-kde plasma-wayland-session plasma-wayland-protocols --noconfirm"
#arch-chroot /mnt /bin/bash -c "pacman -Syu adw-gtk3-git gnome-shell gnome-control-center gnome-text-editor yaru-gnome-shell-theme gdm mpv totem nautilus p7zip unrar evince eog sushi gnome-calculator gnome-calendar gnome-clocks lollypop gnome-system-monitor gnome-tweaks tilix file-roller xdg-desktop-portal-gnome xdg-user-dirs-gtk gnome-browser-connector polkit-gnome seahorse python-nautilus adwaita-qt5 adwaita-qt6 qt5-styleplugins nautilus-image-converter"
...
arch-chroot /mnt /bin/bash -c "useradd -m -g users -s /bin/zsh pedrokw"
...
arch-chroot /mnt /bin/bash -c "sudo -u pedrokw paru -Syu lib32-libgudev lib32-libjpeg6-turbo lib32-libtheora lib32-libusb lib32-libvdpau lib32-openssl lib32-speex lib32-vkd3d libjpeg6-turbo openssl carla menulibre linux-tkg-cfs-generic_v3 linux-tkg-cfs-generic_v3-headers authy ttf-juliamono anydesk-bin visual-studio-code-bin droidcam mangohud lib32-mangohud hunspell hunspell-en_us gvfs gvfs-mtp xdg-desktop-portal libxcrypt-compat net-tools inetutils aria2 hunspell-pt-br heroic-games-launcher-bin wine-tkg-staging-fsync-git vulkan-icd-loader lib32-vulkan-icd-loader noto-color-emoji-fontconfig btop ocs-url pop-icon-theme flatpak flatpak-xdg-utils libportal-qt5 libportal-gtk3 libportal-gtk4 ccache wget ttf-ubuntu-font-family ttf-opensans 64gram-desktop-bin goverlay-git wine-gecko wine-mono wine-nine winetricks zenity neofetch intellij-idea-community-edition pycharm-community-edition icu69-bin gst-plugin-pipewire gst-plugins-ugly gstreamer-vaapi xonotic gnome-sound-recorder gnome-boxes docker notification-daemon bat schedtool lib32-polkit protontricks-git inxi ufetch-git whatsie-git corectrl update-grub unrar p7zip lib32-libappindicator-gtk2 lib32-libappindicator-gtk3 libappindicator-gtk2 libappindicator-gtk3 xsettingsd keepassxc ttf-monoid ttf-fira-code ttf-terminus-nerd ttf-iosevka gnome-calculator gnome-clocks gnome-sound-recorder webapp-manager imagemagick optipng google-chrome gst-plugins-bad gst-libav gst-plugins-good gst-plugins-ugly sdl_image libusb python-pyqt5 python-reportlab python-pillow usbutils youtube-music-bin peek pipewire-jack alsa-oss lib32-alsa-oss alsa-utils cmake checkupdates-aur virtualbox virtualbox-host-dkms virtualbox-guest-iso gimp gimp-extras ttf-jetbrains-mono protonup-qt ttf-ms-fonts ttf-mononoki-nerd ttf-monofur-nerd masterpdfeditor-free vkd3d htop gtk-engine-murrine fastfetch xclip python-pip rsync os-prober glew1.10 lib32-dbus-glib lib32-freeglut lib32-glew1.10 lib32-imlib2 lib32-libcaca lib32-libcurl-compat lib32-libcurl-gnutls lib32-libgcrypt15 lib32-libidn11 lib32-libmikmod lib32-libmodplug lib32-libnm lib32-libpng12 lib32-librtmp0 lib32-libtiff4 lib32-libudev0-shim lib32-libvpx1.3 lib32-libwebp lib32-libxmu lib32-libxt lib32-openssl lib32-sdl12-compat lib32-sdl2 lib32-sdl2_image lib32-sdl2_mixer lib32-sdl2_ttf lib32-sdl_image lib32-sdl_mixer lib32-sdl_ttf libcurl-compat libgcrypt15 libidn11 libmikmod libpng12 librtmp0 libtiff4 libudev0-shim libvpx openssl sdl2_mixer sdl2_ttf sdl_mixer sdl_ttf flac1.3 lib32-flac1.3 gtk-engines gnu-netcat sdl12-compat lib32-pipewire-jack"
#printer pkgs: cups-pdf hplip print-manager cups system-config-printer xsane sane ipp-usb
#timeshift-autosnap qemu-desktop virt-viewer virt-manager tesseract-data-por tesseract-data-eng python-spotdl apache phpmyadmin proton-ge-custom-bin clonezilla ulauncher thunderbird thunderbird-i18n-en-us thunderbird-i18n-pt-br extra-cmake-modules replay-sorcery mpv fish
arch-chroot /mnt /bin/bash -c "sudo -u pedrokw paru -Syu timeshift intel-ucode spotify-launcher powerline-fonts python-pipx docker-compose nodejs npm nvme-cli ttf-roboto ttf-roboto-mono bridge-utils dnsmasq edk2-ovmf libvirt netcat radvd libmms python-protobuf innoextract xorg-xgamma lib32-libpulse lib32-gst-plugins-base gst-plugin-va lib32-gst-plugins-good jdk17-openjdk i2c-tools ddcutil"
