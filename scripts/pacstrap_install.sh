...
arch-chroot /mnt /bin/bash -c "pacman -Syu adw-gtk3-git latte-dock plasma-meta dolphin vlc elisa materia-kde kvantum-theme-materia konsole sddm kvantum spectacle okular firewalld kate kdialog dolphin-plugins ffmpegthumbs gwenview kdegraphics-thumbnailers yakuake ark sweeper kget ksystemlog kmag kdeconnect juk libktorrent qt5-imageformats kimageformats kwalletmanager qtcurve-gtk2 qtcurve-utils --noconfirm"
