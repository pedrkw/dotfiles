...
#arch-chroot /mnt /bin/bash -c "pacman -Syu yaru-gtk-theme yaru-icon-theme yaru-sound-theme adw-gtk3-git gnome-shell gnome-control-center gnome-text-editor yaru-gnome-shell-theme gdm mpv totem nautilus p7zip unrar evince eog sushi gnome-calculator gnome-calendar gnome-clocks lollypop gnome-system-monitor gnome-tweaks tilix file-roller transmission-gtk xdg-desktop-portal-gnome xdg-user-dirs-gtk gnome-browser-connector polkit-gnome seahorse"
