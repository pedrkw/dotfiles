...
arch-chroot /mnt /bin/bash -c "sudo -u pedrokw paru -Syu timeshift intel-ucode spotify-launcher powerline-fonts python-pipx docker-compose nodejs npm nvme-cli ttf-roboto ttf-roboto-mono bridge-utils webapp-manager dnsmasq edk2-ovmf libvirt netcat radvd libmms python-protobuf innoextract xorg-xgamma lib32-libpulse lib32-gst-plugins-base gst-plugin-va lib32-gst-plugins-good jdk17-openjdk i2c-tools ddcutil"
