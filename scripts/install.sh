...
arch-chroot /mnt /bin/bash -c "pacman -Syu paru carla menulibre linux-tkg-cfs-generic_v3 linux-tkg-cfs-generic_v3-headers authy ttf-juliamono spotify anydesk-bin visual-studio-code-bin droidcam mangohud lib32-mangohud hunspell hunspell-en_us hunspell-pt-br heroic-games-launcher-bin wine-tkg-staging-fsync-git vulkan-loader lib32-vulkan-icd-loader noto-color-emoji-fontconfig btop --noconfirm"
...
arch-chroot /mnt /bin/bash -c "pacman -Syu gnome-shell gnome-control-center gnome-text-editor gdm mpv totem nautilus p7zip unrar evince eog sushi gnome-calculator gnome-calendar gnome-clocks lollypop gnome-system-monitor gvfs gvfs-mtp tilix xdg-user-dirs-gtk xdg-desktop-portal xdg-desktop-portal-gnome libxcrypt-compat net-tools inetutils file-roller transmission-gtk aria2"
