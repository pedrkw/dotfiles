...
arch-chroot /mnt /bin/bash -c "pacman -Syu gnome-shell gnome-control-center gnome-text-editor gdm mpv totem nautilus p7zip unrar evince eog sushi gnome-calculator gnome-calendar gnome-clocks lollypop gnome-system-monitor gvfs gvfs-mtp tilix xdg-user-dirs-gtk xdg-desktop-portal xdg-desktop-portal-gnome libxcrypt-compat net-tools inetutils file-roller transmissions-gtk aria2"
